...
(function() {
  var Steppers, addTest, check, child1_ready, child1_started, log, log0, received_steps, reset_steps, setup_test, step_listeners, test_insert, test_remove, test_update, test_update_multiple, wait_for_step, _when,
    __slice = [].slice,
  ...
  setup_test = function(testName, who) {
    ...
    parent(function() {
      ...
      return Meteor.BrowserSQLCollection.erase();
    });
    parent(function() {
  ...
  test_insert = function(who) {
    ...
    _ref = steppers.steppers, parent = _ref.parent, child1 = _ref.child1;
    parent(function() {
      return this.foo = new Meteor.BrowserSQLCollection('foo', function() {
    ...
    child1(function() {
      ...
      this.foo = new Meteor.BrowserSQLCollection('foo', function() {
  ...
  test_update_multiple = function(who) {
    ...
    parent(function() {
      var _this = this;
      this.foo = new Meteor.BrowserSQLCollection('foo', function() {
        return _this.doc_id1 = _this.foo.insert({
          abc: 11,
          color: 'red'
        }, function() {
          return _this.doc_id2 = _this.foo.insert({
            abc: 22,
            color: 'red'
          }, function() {
            return _this.doc_id3 = _this.foo.insert({
              abc: 33,
              color: 'green'
            }, function() {
              return _this.doc_id4 = _this.foo.insert({
                abc: 44,
                color: 'green'
              }, function() {
                return Meteor.BrowserMsg.send('test_step', 'child1', 'start watching foo');
