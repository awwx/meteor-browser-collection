...
(function() {
  var Steppers, addTest, check, child1_ready, child1_started, firefox, insert_four, log, log0, received_steps, reset_steps, setup_test, step_listeners, test_insert, test_persistent, test_remove, test_remove_multiple, test_update, test_update_multiple, wait_for_step, _when,
    __slice = [].slice,
  ...
  setup_test = function(testName, who) {
    ...
    parent(function() {
      ...
      return Meteor.BrowserCollection.erase();
    });
    parent(function() {
