    ...
    _reload_all: function() {
      ...
      return store.transaction('_reload_all', function(tx) {
        ...
        LocalCollection._diffQueryUnorderedChanges(oldResults, newResults, {
          added: function(id) {
            return _this._localCollection.insert(newResults[id]);
          },
          changed: function(id) {
            return _this._localCollection.update(id, _.omit(newResults[id], '_id'));
          },
          removed: function(id) {
            return _this._localCollection.remove(id);
          }
        });
      }), (function(error) {
