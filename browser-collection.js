...
(function() {
  var IndexedStore, SQLStore, catcherr, collections, each_sql_result, idMap, idOf, log, promize, request_to_promise, result_as_array, store, stringify, _when,
    __slice = [].slice;
  ...
  IndexedStore = (function() {
    ...
    IndexedStore.prototype.transaction = function(desc, withTransaction) {
      ...
      deferred.promise.then((function() {
        return log("-- " + desc + " transaction promise resolved");
      }), (function(error) {
        return log("-- " + desc + " transaction promise rejected:", error);
      }));
      return deferred.promise;
    };
    ...
    IndexedStore.prototype.erase_database = function() {
      ...
      return this.transaction('erase_database', function(tx) {
        ...
        req = documents.openCursor();
        req.onerror = function(event) {
          return log('erase_database error', event);
        };
        req.onsuccess = function(event) {
          var cursor;
          cursor = req.result;
  ...
  _.extend(Meteor.BrowserCollection.prototype, {
    ...
    _reload_all: function() {
      ...
      return store.sqldb.transaction((function(tx) {
        ...
        return log('_reload_all transaction error', error);
      }), (function() {
