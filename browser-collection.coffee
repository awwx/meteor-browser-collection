...
# Firefox console log displays not what an object *was* at the time it
# was logged to the console but what it contains *now*, so stringify
# all our debug log messages.
